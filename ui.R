             ...
             sidebarLayout(
               ...
               mainPanel(
                 div(class = "sobre-texto",
                     ...
                     h2("Como plotar?"),
                     br(),
                     div(style= "color:black;font-weight:semi-bold","Altere os dados que deseja,clique em 'Confirmar', Em seguida vá na proxima aba chamada 'Plotagem', e clique em 'Gerar Parcelas', ao lado haverá outra aba chamada 'Mapa das parcelas' e você poderá visualizar as parcelas que foram plotadas.")  
