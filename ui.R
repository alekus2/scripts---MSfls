                      ...
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          conditionalPanel("input.tipo_parcela == 'IPC'", 
                                           radioButtons("lancar_sobrevivencia", label = h3("Deseja lançar as parcelas de sobrevivência?"),
                                                        choices = list("Sim" = 1, "NÃO" = 0), selected = 0)),
                          sliderInput("distancia_minima", label = h3("Distância Miníma: "), min = 5, max = 25, value = 20, step = 0.5),
                        ...
                        mainPanel(
                          tags$div(class = "sobre-texto",
                                   ...
                                   tags$p("Serão obrigatórias as seguintes colunas na tabela de atributos: AREA_HA, ID_PROJETO, ID_TALHAO, CICLO, ROTACAO."),
                          ...
                          conditionalPanel(
                            ...
                            tags$p("*Disponível após o upload das demais informações")
                          )
                        )
                      )),
                        ...
                        tabPanel("Download", icon = icon("download"),
                                 sidebarLayout(
                                   sidebarPanel(tags$div(class = "sobre-texto",
                                                ...
                                                tags$div(class = "sobre-texto",
                                                         tags$p("Nota: Será necessário alterar o nome para cada arquivo a ser salvo."))),
