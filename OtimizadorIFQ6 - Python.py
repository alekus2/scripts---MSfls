...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        def _calc_row(row):
            ...
            return pd.Series({
                "n": n, #entao pelo oq eu vi o "n" deveria contar se tivesse >0 mas ele não conta direito. então tudo q for 0 ele tem q contar tambem, mas se o valor estiver nulo ele não conta entao tem q transformar aonde não tem maximo de parcelas em nulos.
                "n/2": half,
                "Mediana": med,
                "∑Ht": soma_total,
                "∑Ht(<=Med)": soma_le,
