...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        df_D_resultados = df_D.copy()
        metrics_D = df_D_resultados.apply(calc_metrics, axis=1, covas=num_cols_D)
        df_D_resultados = pd.concat([df_D_resultados[cols0 + num_cols_D], metrics_D], axis=1)
