...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        #queria que o codigo verificasse se o check pits deu 0 ou se deu 1 e se der 1 ele não arredonda e se der -1 ele arredonda. mas é só para esses casos em q der exatamente 1 ou -1
