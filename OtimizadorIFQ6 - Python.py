    ...
    def validacao(self, paths):
        ...
        df_tabela["Stand (tree/ha)"] = (
          ...
          - df_tabela[falhas].sum(axis=1)
            #na verdade acho q ta meio errado isso pq ele deveria contar de "A" até "E" contando com as falhas e talz ai depois subtrair com as falhas e o resultado disso multiplicar por 10000 e dividir por "nm_area_parcela". E isso vale n só para esse.
        )
