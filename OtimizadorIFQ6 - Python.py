...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        # --- leitura e validação inicial dos arquivos ---
        for path in paths:
        ...
        # --- checagens duplicados e códigos ---
        ...
        # --- prepara df_tabela com colunas 1..N ---
        ...
        # <<< INSERÇÃO: cálculo de n, n/2, Mediana, ∑Ht, ∑Ht(<=Med) e PV50 >>>
        def _calc_row(row):
