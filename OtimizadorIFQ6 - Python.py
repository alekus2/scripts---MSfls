...
Traceback (most recent call last):
  File "f:\Qualidade_Florestal\02- MATO GROSSO DO SUL\11- Administrativo Qualidade MS\00- Colaboradores\17 - Alex Vinicius\Automações em python\Automatizacao_IFQ6\script\OtimizadorIFQ6 - Python.py", line 168, in <module>
    otimizador.validacao(arquivos)
  File "f:\Qualidade_Florestal\02- MATO GROSSO DO SUL\11- Administrativo Qualidade MS\00- Colaboradores\17 - Alex Vinicius\Automações em python\Automatizacao_IFQ6\script\OtimizadorIFQ6 - Python.py", line 74, in validacao
    df.columns = [col.upper() for col in df.columns]
  File "f:\Qualidade_Florestal\02- MATO GROSSO DO SUL\11- Administrativo Qualidade MS\00- Colaboradores\17 - Alex Vinicius\Automações em python\Automatizacao_IFQ6\script\OtimizadorIFQ6 - Python.py", line 74, in <listcomp>
    df.columns = [col.upper() for col in df.columns]
AttributeError: 'int' object has no attribute 'upper'
PS F:\Qualidade_Florestal\02- MATO GROSSO DO SUL\11- Administrativo Qualidade MS\00- Colaboradores\17 - Alex Vinicius\Automações em python\Automatizacao_IFQ6> 
