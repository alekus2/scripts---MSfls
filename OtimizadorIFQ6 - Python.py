...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        for code in codes_to_count:
            df_tabela[code] = (df_final["CD_01"] == code).cumsum() #Ele tem q contar por talhão ele n pode contar repetidos tem q ser só do talhao de da parcela atual q esta contando q ele vai procurando e contando.
