...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        def _calc_row(row):
            ...
            return pd.Series({
                "n": n, #entao pelo oq eu vi o "n" deveria contar se tivesse >0 mas ele não conta direito. então tudo q for 0 ele tem q contar tambem, mas se o valor estiver nulo ele não conta entao tem q transformar após chegar ao maximo de nm_cova_ordenada restante em nulos e não contar em "n" se estiver nulo.
                "n/2": half,
                "Mediana": med,
                "∑Ht": soma_total,
                "∑Ht(<=Med)": soma_le,
