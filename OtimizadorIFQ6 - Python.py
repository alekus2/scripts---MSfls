...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        area_col = next((c for c in cols_cad if "ÁREA" in c.upper()), None)
...
=== DEBUG df_res.head() ===
  Área (ha) Chave_stand_1  CD_PROJETO CD_TALHAO  nm_parcela  nm_area_parcela  \
0       NaN    6234-007-1        6234       007           1              400   
1       NaN    6234-007-1        6234       007           1              400   
2       NaN    6234-007-1        6234       007           1              400   
3       NaN    6234-007-1        6234       007           1              400   
4       NaN    6234-007-1        6234       007           1              400   

   NM_COVA_ORDENADO  Ht média  
0                 1       1.9  
1                 2       2.0  
2                 3       2.0  
3                 4       2.0  
4                 5       2.1  
✅ Tudo gravado em '/Maio/output/BASE_IFQ6_Maio_20250514_03.xlsx'
