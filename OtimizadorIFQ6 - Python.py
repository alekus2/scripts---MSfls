...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        if "PV50" in df_D_tabela.columns:
            df_D_tabela["PV50"] = pd.to_numeric(df_D_tabela["PV50"], errors='coerce') #acredito eu que seja mais facil ele criar uma nova coluna que faz esse calculo matematico assim como as outras doq copiar, oq n faz sentido sendo q eu pedi so para copiar as colunas mas nao os valores pois os valores vao ser alterados com o quesito em que as colunas numericas de 1 até N maximo de covas ordenadas vai ser alteradas para ao cubo pois assim o resto das contas matematicas não muda.
