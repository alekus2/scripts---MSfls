...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        df_final.sort_values(["CD_PROJETO","CD_TALHAO","NM_PARCELA","Ht média"], inplace=True)
        ...
        df_res = pd.merge(
            df_final, df_cadastro[["Index_z3", area_col]],
        ...
        # — Cálculo df_tabela (igual ao original) —
        ...
        # — Cálculo df_D_resultados com alturas ao cubo e sobrevivência segura —
        ...
        # remover coluna decimal antes de salvar
