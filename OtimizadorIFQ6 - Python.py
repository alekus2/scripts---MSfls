...
class OtimizadorIFQ6:
    def validacao(self, paths):
        ...
        def arredondamento_banco(x):
           #o codigo deverá verificar se o pits/ha e pits por sob são impar e impar ou par e par e se não forem adicionar mais um se for primeiro impar depois par e remover um se for par depois impar.
