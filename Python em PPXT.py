...
def adicionar_imagem_ao_slide(arquivo_modelo, slide_index, titulo, imagem_path, arquivo_saida):
    try:
        ...
        if caixa_texto_encontrada:
            ...
            novo_texto = "Programado: XXX,X mil ha. Meta semanal: XX,X mil ha. Realizado última semana: XX,X mil ha. Semana atual: XX,X mil ha. Percentual de realização: XX%. Fechamento do Bloco: XX/XX/XXXX. Última Semana:XXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXX XXXXXXXXX XXXXXXXX"
            ...
            for item in ["Item 1", "Item 2", "Item 3"]:
                ...
                p.level = 6  # Define o nível do marcador (0 = padrão)
