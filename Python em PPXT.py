...
try:
  ...
  def adicionar_imagem_ao_slide(arquivo_modelo, slide_index, titulo, imagem_path, arquivo_saida):
    try:
      ...
      print("Não foi possivel concluir sua ação,pois não há nenhuma apresentação com esse nome no diretório.")
  arquivo_modelo = "Acompanhamento semanal_04_edit.pptx" 
  slide_index = 2
  arquivo_saida = "Acompanhamento semanal_04_atualizado.pptx" #FAVOR:lembrar de mudar os nomes para que o excel pegue na tabela para transformar o modelo para ser totalmente editavel de forma que so precise do excel e o script
  ...
  print ("Seu arquivo não foi encontrado ou não existe.")
